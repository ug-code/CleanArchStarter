using CleanArchStarter.Application.Common.Models;
using CleanArchStarter.Application.TodoItems.Commands.CreateTodoItem;
using CleanArchStarter.Application.TodoItems.Commands.DeleteTodoItem;
using CleanArchStarter.Application.TodoItems.Commands.UpdateTodoItem;
using CleanArchStarter.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CleanArchStarter.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace CleanArchStarter.Web.Endpoints;
